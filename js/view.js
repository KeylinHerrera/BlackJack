function GameView(config) {
		...
		/**
		 * Renders player cards in the DOM
		 * @param      {Object}  state   Current state of the model data
		 */
		...
		/**
		 * Renders dealer cards in the DOM
		 * @param      {Object}  state   Current state of the model data
		 */
		...
		/**
		 * Renders a end´s message in the DOM
		 * @param      {Object}  state   Current state of the model data
		 */
