function Dealer() {
	...
	/**
	 * Deal function to start a game with bet
	 * Command pattern
	 * @param      {Object}  state   Current state of the model data
	 * @return     {function} new game 
	 */
	...
	/**
	 * Stand function to stop the player's move
	 * Command pattern
	 * @param      {Object}  state   Current state of the model data
	 * @return     {function}     stop the player's move and start the dealer's move  
	 */
	...
	/**
	 * Resolve function to give the status of the move
	 * Command pattern
	 * @param      {Object}  state   Current state of the model data
	 * @return     {function}     game status  
	 */
...
/**
 * Card function to create random deck
 * Constructor
 * @return     {function}     random deck
 */
Deck.prototype = {
	contructor : Deck,
...
/**
 * Card function to create all cards of deck
 * @param     value, name, suit
 * @return     {function}     all cards  
 */
